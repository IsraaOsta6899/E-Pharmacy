                ...
                <div class="pb-2">
                    <div class="product-item d-flex flex-column align-items-center text-center rounded py-5 px-3 " style="width:100%">
                        ...
                        <div class="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 150px; height: 150px;">
                            <img class="rounded-circle w-100 h-100" src="images/fo.png" style="object-fit: cover;">
                        </div>
                        <h5 class="font-weight-bold mb-4"><c:out value="${medicine.getName() }"></c:out>Med Name</h5>
