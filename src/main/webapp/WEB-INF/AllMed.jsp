    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="section-title position-relative text-center mb-5">All Medicines Available</h1>
                </div>
            </div>
            <c:forEach var="medicine" items="${AllMedicines}">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="product-item d-flex flex-column align-items-center text-center rounded py-5 px-3">
                        <div class="bg-primary mt-n5 py-3" style="width: 80px;">
                            <h4 class="font-weight-bold text-black mb-0"><c:out value="${medicine.getMedicinePrice() }"></c:out>$$$</h4>
                        </div>
                        <div class="position-relative bg-primary rounded-circle mt-n3 mb-4 p-3" style="width: 150px; height: 150px;">
                            <img class="rounded-circle w-100 h-100" src="images/pills.jpg" style="object-fit: cover;">
                        </div>
                        <h5 class="font-weight-bold mb-4"><c:out value="${medicine.getMedicineName() }"></c:out>Med Name</h5>
