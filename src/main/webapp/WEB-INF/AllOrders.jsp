...
<table class="table">
			  ...
			  <tbody>
			  <c:forEach var="order" items="${AllOeders}">
			  <tr>
			  	<td><c:out value="${order.getId()}"></c:out></td>
			  	<td><c:out value="${order.getUserr().getUserName() }"></c:out></td>
			  	<td><c:out value="${order.getUserr().getEmail() }"></c:out></td>
			    <td><c:out value="${order.getTotalPrice()}"></c:out></td>
			  	
			 	<td><button type="button" class="btn btn-success"><a href="/accept/${order.getId()}">Success</a> </button>
<button type="button" class="btn btn-danger"><a href="/reject/${order.getId()}">Reject</a></button></td>
			  </tr>
			  </c:forEach>
